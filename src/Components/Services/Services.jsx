...
const Services = () => {
  return (
    <div className="services" id="services" data-aos="fade-up">
      <div className="services main-container" data-aos="fade-up">
        <h3 className="pre-title">Services</h3>
        <h1 className="section-title services-title">Specialized In</h1>

        <div className="services-list-grid">
          
          <div className="service-item-card" data-aos="fade-up" data-aos-delay="200">
            <div className="service-icon-box uiux"><SiFigma /></div>
            <h4>UI/UX Design</h4>
          </div>

          <div className="service-item-card" data-aos="fade-up" data-aos-delay="300">
            <div className="service-icon-box app"><MdAppRegistration /></div>
            <h4>App Development</h4>
          </div>

          <div className="service-item-card" data-aos="fade-up" data-aos-delay="400">
          ...
          <div className="service-item-card" data-aos="fade-up" data-aos-delay="900">
            <div className="service-icon-box mobile"><FaMobileAlt /></div>
            <h4>Mobile Dev</h4>
          </div>

          <div className="service-item-card" data-aos="fade-up" data-aos-delay="1000">
            <div className="service-icon-box cloud"><FaCloudUploadAlt /></div>
            <h4>Cloud & Deploy</h4>
          </div>

          <div className="service-item-card" data-aos="fade-up" data-aos-delay="1100">
