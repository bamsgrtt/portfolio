    ...
    <div className='services' data-aos="fade-up">
      <div className="services main-container" data-aos="fade-up">
        ...
        <div className="grid-3">
          <div className="service" data-aos="fade-up" data-aos-delay="200" data-aos-animate="aos-init aos-animate">
          ...
          <div className="service" data-aos="fade-up" data-aos-delay="300" data-aos-animate="aos=init aos-animate">
            <div className="service-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
          ...
          <div className="service" data-aos="fade-up" data-aos-delay="400" data-aos-animate="aos=init aos-animate">
            <div className="service-icon">
              <svg
                width="24"
                height="24"
